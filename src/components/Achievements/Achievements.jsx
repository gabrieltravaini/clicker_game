...
function Achievements({ achievea, achieveb, achievec, ...props }) {
  ...
  const achievementsList = [
    { name: 'Upgrade Master', desc: 'You bought 10 upgrades!', icon: achieveaImg, status: achievea },
    { name: 'Top Scorer', desc: 'You scored over 1,000,000!', icon: achievebImg, status: achieveb },
    { name: 'Mouse Breaker', desc: 'You clicked over 300 times!', icon: achievecImg, status: achievec },
  ];
